...
vim.api.nvim_create_autocmd('LspAttach', {
  ...
  callback = function(args)
    ...
    map({ 'n', 'v' }, '<localleader>ca', vim.lsp.buf.code_action, { desc = 'Code action' })
    map('n', '<localleader>rn', vim.lsp.buf.rename, { desc = 'Rename symbol' })
    ...
    map('n', '<localleader>wa', vim.lsp.buf.add_workspace_folder, { desc = 'Add workspace folder' })
    map('n', '<localleader>wr', vim.lsp.buf.remove_workspace_folder, { desc = 'Remove workspace folder' })
